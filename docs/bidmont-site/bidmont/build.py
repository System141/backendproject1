...
NAV = [
    ...
    ("Partner Auctions", "auctions.html", "auctions"),
...
FOOT_COLS = [
    ("Marketplace", [("Partner Auctions", "auctions.html"), ("Categories", "auctions.html#categories"),
    ...
    ("Company", [("About Us", "#"), ("Careers", "#"), ("News", "#"), ("Contact Us", "#")]),
...
HOW = [("userplus", "Create account", "Sign up and verify your identity in a few minutes."),
       ...
       ("lock", "Unlock auctions", "Spend credits to open verified partner auction details."),
       ("target", "Bid with the partner", "Place your bid on the partner platform and win.")]
home_steps = ""
...
<div class="promo">
<div>
<h2 class="h2" style="margin-bottom:8px">For auction partners &amp; sellers</h2>
<p class="lead" style="font-size:13.5px">Reach serious, verified buyers worldwide through BidMont. You keep your platform — we bring the demand.</p>
...
<div class="feature"><span class="ic">{i("handshake", 19)}</span><div><b>No platform switch</b><span>Bidding stays on your own auction platform.</span></div></div>
</div>
</div>
</section>
...
FAQ_ITEMS = [
    ("What are BidMont credits?", "Credits are the access currency on BidMont. You spend them to open the full details of a verified partner auction — photos, condition reports, seller information and the bidding link."),
...
<p class="tiny" style="margin-bottom:18px">Credits are used to access auction details and place bids on partner platforms.</p>
...
<div>
<h1 class="h1" style="font-size:clamp(28px,5vw,40px)">Partner <span class="red">Auctions</span></h1>
<p class="lead" style="margin-top:8px;font-size:13.5px">Access verified partner auctions across vehicles, heavy equipment, real estate, marine assets, industrial machinery and more.</p>
</div>
...
<a href="auth.html">{i("user", 20)}<span>Account</span></a>
</nav>'''
